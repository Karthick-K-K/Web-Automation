...
time.sleep(2)
pname = "New2"
driver.find_element(By.NAME, "name").send_keys(pname)
...
savecta.click()
time.sleep(2)
avaiprofiles1 = driver.find_elements(By.XPATH, "//button[@type='submit']")
...
driver.find_element(By.CSS_SELECTOR, "button[data-automation-id='profiles-ww-edit']").click()
...
driver.find_element(By.XPATH, "//a[text()='Remove']").click()

time.sleep(2)

driver.find_element(By.XPATH, "//button[text()='Remove profile']").click()
if len(avaiprofiles) == len(avaiprofiles1):
